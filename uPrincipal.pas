...
begin
  ...
  try
    ...
    Linha.S['title']       := 'Promoção de Medicamentos'; //AddPair('title', 'Promoção de Medicamentos');
    Linha.S['description'] := 'Confira as promoções especiais de medicamentos desta semana.'; //AddPair('description', 'Confira as promoções especiais de medicamentos desta semana.');
    ...
    Linha.S['description'] := 'Conheça os novos produtos disponíveis em nossa farmácia.'; //AddPair('description', 'Conheça os novos produtos disponíveis em nossa farmácia.');
    ...
    Linha := SO(); //TJSONObject.Create;
    Linha.S['title'] := 'Histórico de Pagamentos';
    Linha.S['description'] := 'Consulte seu histórico de pagamentos.';
    ...
    Secao := SO();
    Secao.S['title'] := 'Dúvidas'; //AddPair('title', 'Dúvidas');
    Linhas := SA([]); //TJSONArray.Create;

    Linha := SO(); //TJSONObject.Create;
    Linha.S['title']       := 'Horário de Funcionamento'; //AddPair('title', 'Horário de Funcionamento');
    Linha.S['description'] := 'Saiba os horários de funcionamento de nossas lojas.'; //AddPair('description', 'Saiba os horários de funcionamento de nossas lojas.');
